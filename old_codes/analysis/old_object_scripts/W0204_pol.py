...
for filter in filters:
    ...
    if filter=="R_SPECIAL":
        ob_ids = [3565580, 3565504, None]
        mjds = ["60207", "60209", None]


    pol_frac, pol_angle, epol_frac, epol_angle = get_pol("W0204-0506", ex_ref, ey_ref, rim_folder, filter, mask_folder, crz_folder, ob_ids=ob_ids, mjds=mjds, r_ap=1.0, force=args.force_new)

    fname = "W0204_pol_{}".format(filter)
