...
for filter in filters:
    ...
    if filter=="R_SPECIAL":
        ob_ids = [3565583, 3565623, None]
        mjds = ["60201", "60207", None]


    pol_frac, pol_angle, epol_frac, epol_angle = get_pol("W0220+0137", ex_ref, ey_ref, rim_folder, filter, mask_folder, crz_folder, ob_ids=ob_ids, mjds=mjds, r_ap=1.0, force=args.force_new)

    fname = "W0220_pol_{}".format(filter)
