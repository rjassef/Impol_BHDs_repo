...
class ddust_torus(object):
    ...
    def __init__(self, dust_type, fw=True, bw=True, folder="fullspec_dust_models"):
        ...
        self.pfrac = RegularGridInterpolator((self.wave_grid, self.theta_grid, self.psi_grid), self.p_grid, bounds_error=False, fill_value=None)
    ...
    def read_model(self):
        ...
        for k, wave in enumerate(wave_grid):
            dust = draine_dust(wave, self.dust_type, folder=base_folder)
