...
def run_pol(obj_name, obs_params, ex_ref, ey_ref, r_ap=1.0, save_output=True):
    ...
    for filter in obs_params.keys():
        ...
        pol_frac, pol_angle, epol_frac, epol_angle = get_pol(obj_name, ex_ref, ey_ref, rim_folder, filter, mask_folder, crz_folder, ob_ids=ob_ids, mjds=mjds, r_ap=r_ap, force=args.force_new)
