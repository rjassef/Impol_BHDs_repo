...
c     also convert angstroms to microns
      ...
      open(unit=13,file='/Users/rassef/OSU/AGN_IRAC/GR45_All/codes/brown/Vega.sed',form='formatted',status='old')
      read(13,*)nvega
      do i=1,nvega
...
c     Read the Filters
      ...
      do jchan=1,nchan
         ...
         write(fname,'(a,a,a)')'/Users/rassef/OSU/AGN_IRAC/GR45_All/codes/Filters/',trim(bname(jchan)),'.filter'
         inorm = inorm2(jchan)
...
c     Start by reading the filter curve
         open(unit=95,
     *        file='/Users/rassef/OSU/AGN_IRAC/GR45_All/codes/Filters/IRAC_ch4_total_response.filter',
     *        status='old')
...
c     Start by reading the filter curve
         open(unit=95,
     *        file='/Users/rassef/OSU/AGN_IRAC/GR45_All/codes/Filters/kband.filter',
     *        status='old')
         read(95,*)nfilt(jchan)
         do i=1,nfilt(jchan)
...
c     Start by reading the filter curves
         do j=1,3
            if(j.eq.1) then
               open(unit=95,
     *         file='/Users/rassef/OSU/AGN_IRAC/GR45_All/codes/Filters/sdssg.filter',
     *              status='old')
            else if(j.eq.2) then
               open(unit=95,
     *         file='/Users/rassef/OSU/AGN_IRAC/GR45_All/codes/Filters/sdssr.filter',
     *              status='old')
            else
               open(unit=95,
     *         file='/Users/rassef/OSU/AGN_IRAC/GR45_All/codes/Filters/kband.filter',
     *              status='old')
c               open(unit=95,
c     *         file='/Users/rassef/OSU/AGN_IRAC/GR45_All/codes/Filters/K_atmccd.filter',
c     *              status='old')
            endif
...
c     Start by reading the filter curve
         open(unit=95,
     *        file='/Users/rassef/OSU/AGN_IRAC/GR45_All/codes/Filters/B_bessell.filter',
     *        status='old')
         read(95,*)nfilt(jchan)
         do i=1,nfilt(jchan)
            read(95,*)lamf(jchan,i),eff(jchan,i)
...
c     Start by reading the filter curve
         open(unit=95,
     *        file='/Users/rassef/OSU/AGN_IRAC/GR45_All/codes/Filters/IRAC_ch1_total_response.filter',
     *        status='old')
         read(95,*)nfilt(jchan)
         do i=1,nfilt(jchan)
            read(95,*)lamf(jchan,i),eff(jchan,i)
